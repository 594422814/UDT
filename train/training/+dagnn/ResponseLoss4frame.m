classdef ResponseLoss4frame < dagnn.Loss
...
% -------------------------------------------------------------------------------------------------------------------------
    ...
    methods
        function outputs = forward(obj, inputs, params)
            ...
            r3 = inputs{3}; % middle result of Z3
            r4 = inputs{4}; % final label of X
            r5 = inputs{5}; % initial label of X
            
            % original loss
            res_minus = bsxfun(@minus,r4,r5);
            ...
            % the motion between Z2 and Z3
            delta3 = bsxfun(@minus,r2,r3);
            delta = delta1.*delta1 + delta2.*delta2  + delta3.*delta3;
        ...
        function [derInputs, derParams] = backward(obj, inputs, params, derOutputs)
            ...
            derInputs{2} = {};
            derInputs{3} = {};
            derInputs{4} = (derOutputs{1}*2/size(r3,4)).*bsxfun(@minus,r4,r5).*weight ;
            derInputs{5} = {};
            derParams = {} ;
        end
        ...
        function obj = ResponseLoss4frame(varargin)
            obj.load(varargin);
